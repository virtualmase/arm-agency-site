...
const leaders: LeaderProfile[] = [
  ...
  },
  {
    ...
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/91150550/HenVFyedgRXqSfEw.jpeg",
        ...
        <div className="container">
          ...
          >
            {leaders.map((leader, index) => (
              ...
              >
                {/* Image */}
                <div className={`relative h-96 rounded-lg overflow-hidden border border-white/10 glass-steel group ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
            <img
              src={leader.image}
              alt={leader.name}
